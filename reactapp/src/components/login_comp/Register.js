  ...
  <div className="flex"> 
    ...
    <div className="create">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <button style={{color:'white',fontWeight:'200',fontFamily:'Montserrat, sans-serif',padding:'13px 38px 13px 7px', width:'250px',border:'none',borderRadius:'4px', backgroundColor:'#d1410c', cursor:'pointer', textDecoration:'none'}} className="logregbtn"><a  style={{textDecoration:"none", color:'white'}} href="/Login" ><span style={{textDecoration:"none"}}>Register</span></a></button>
      </form><br/>
      <hr style={{width:'237px'}}/>
      <span style={{fontSize:'13px'}}>Already have an account? <span style={{cursor:'pointer',color:'#d1410c'}}><a style ={{textDecoration:'none', color:'#d1410c'}}href="/Login">Sign in!</a></span></span>
    </div>
   </div> 
