...
const handleClick=async ()=>{
   ...
   try {
         const purchase= await axios.post(`/ticket/purchase/${eventId}/${data._id}`,{eventId:eventId,ticketId:data._id,ticket});   //NOTE TO INCLUDE USER DATEILS HERE AFTER COMPLETION
   }
  catch(err){
     console.log(err);
  }
