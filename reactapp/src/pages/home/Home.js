    ...
    < div className='home'>
      ...
      <div className="contone">
        <div className="contonecont">
          <span className='lonetit' style={{ fontWeight: '300', fontSize: '70px' }}><b>Have any <span style={{ color: "red" }}>weekend plans?</span></b></span><br /><br />
          <span className="lonecontent" style={{ fontWeight: '300' }}>Looking for something to do lately? Whether you're a local, new in town or just cruising <br />through we've got loads of great tips and events-from thrilling concerts to thought-provoking <br />conferences, we have a wide variety of experiences for you to choose from.You can explore<br /> by location, popularity, free stuff... you got this. Ready?</span><br /><br />
      ...
      <div className="contthreecont">
       ...
       {/* UPCOMING EVENTS */}
        ...
        {/* UPCOMING EVENTS */}
        {/* <span><FontAwesomeIcon icon={faClockRotateLeft} style={{paddingTop:'70px', fontSize:'27px', paddingLeft:'137px', paddingRight:'30px'}}/></span>
      <span className='idli'>UPCOMING EVENTS</span><br/>
      <div className="main-scroll-div">
        <div className="cover">
        <div className="trendcont">
          <div className="trendbox"><img className="trendboximg"src={g}></img></div>
          <div className="trendbox"><img className="trendboximg"src={h}></img></div>
          <div className="trendbox"><img className="trendboximg"src={i}></img></div>
          <div className="trendbox"><img className="trendboximg"src={j}></img></div>
          <div className="trendbox"><img className="trendboximg"src={k}></img></div>
          <div className="trendbox"><img className="trendboximg"src={l}></img></div>
        </div>
        </div>
      </div>       */}


        {/*SEARCHBAR. SEARCH CLICK BUTTON FUNCTION YET TO BE DEFINED. SOME ERRORS YET TO BE FIXED  */}
        ...
        {/* button onclick={onSearch} */}
          ...
          <div className="input-group" style={{marginLeft:'560px'}}>
    <input type="text" name="text" className="input" id="Email"  placeholder="search fro location, date or timing!" onChange={(evt)=>{setCity(evt.target.value)}}/>
    <button className="button--submit"onClick={onSearch} >SEARCH</button>
</div>
          
          {/* <div className="headerSearchItem"><FontAwesomeIcon icon={faCalendarDays} className='headerIcon' />
      ...
      <div className="conttwo">
        <div className="conttwocont">
          <span className='ltwotit' style={{ fontWeight: '300', fontSize: '70px', color: 'white' }}><b>Got an act <span style={{ color: "#3978ff" }}>worth showing?</span></b></span><br /><br />
          ...
          <span className="clicknoq" style={{ fontWeight: '300' }}>Create event!<FontAwesomeIcon icon={faArrowRight} className='arrowright' /></span>
        </div>
      ...
      <div className="contfour">
        <div className="contfourcont">
          <span className='ltwotit' style={{ fontWeight: '300', fontSize: '70px', color: 'white' }}><b><span style={{ color: "rgb(192 255 57)" }}>EVENTBRITE: </span>Ticketing<br /> made easy!</b></span><br /><br />
          <span className="ltwocontent" style={{ fontWeight: '300', color: 'white' }}>Publish your event in under five minutes.
            Craft unique experiences using our simple<br /> and powerful event platform. Create, ticket and host both on-ground and digital<br /> events on a platform used by millions of live event loving fans.</span><br /><br />
